	...
	<form:form id="regForm" modelAttribute="user" action="registerProcess"
		...
		<table align="center">
			<tr>
				...
				<td><form:input path="login.loginId" name="loginId" id="loginId" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><form:input path="address.line1" name="address" id="address" /></td>
			</tr>
			<tr>
				<td><form:label path="address.line2">Line2:</form:label></td>
				<td><form:input path="address.line2" name="address" id="address" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><form:input path="address.state" name="address" id="address" /></td>
			</tr>
			<tr>
				<td><form:label path="address.country">Country:</form:label></td>
				<td><form:input path="address.country" name="address" id="address" /></td>
			</tr>
			<tr>
